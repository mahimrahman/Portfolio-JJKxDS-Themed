...
const WaterBreathingCrest = () => (
  <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-80">
    <path d="M50 10C27.9086 10 10 27.9086 10 50C10 72.0914 27.9086 90 50 90" stroke="#3F51B5" strokeWidth="8" strokeLinecap="round"/>
    <path d="M50 90C72.0914 90 90 72.0914 90 50C90 27.9086 72.0914 10 50 10" stroke="#A855F7" strokeWidth="8" strokeLinecap="round" strokeDasharray="2 12"/>
    ...
    <path d="M50 40C48.067 40 46.5 41.567 46.5 43.5C46.5 45.433 48.067 47 50 47C55.5228 47 60 51.4772 60 57C60 62.5228 55.5228 67 50 67C44.4772 67 40 62.5228 40 57" stroke="#F4C542" strokeWidth="5" strokeLinecap="round"/>
  </svg>
);

const SunBreathingCrest = () => (
  <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="opacity-80">
    <circle cx="50" cy="50" r="35" fill="#F4C542" stroke="#FF4E00" strokeWidth="4"/>
    ...
    <circle cx="50" cy="50" r="15" fill="#FF4E00" stroke="#F4C542" strokeWidth="2"/>
  </svg>
);
