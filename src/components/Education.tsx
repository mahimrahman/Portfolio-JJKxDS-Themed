...
const Education: React.FC = () => {
  ...
  return (
    <section id="education" className="pt-16 pb-12 px-4 sm:px-6 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-center text-sm md:text-base text-ash-gray mb-3 max-w-xl mx-auto">
